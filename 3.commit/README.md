...
Commit, Pull, Push에 대해 알아봅시다.

## 변경사항 만들기

현재 있는 내용에 변경 사항이 있어야 저장할 수 있겠죠? 현재 디렉토리 안에 있는 profile.txt 파일을 열어서 수정을 해보고 저장 해 줍니다.
...
협업을 할 때는 다른 사람이 작업한 내용이 있을 가능성이 높으므로 작업을 하기 전에 최신의 정보를 다운받아 작업 내용을 최신하하고 본인의 작업을 한다고 생각하면 됩니다.
